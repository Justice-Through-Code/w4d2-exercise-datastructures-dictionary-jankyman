...
def favorite_restaurant():
    ...
    favorite_restaurant["name"] = input("Enter the name of your favorite resturaunt: ")
    favorite_restaurant["address"] = input("Enter the address of your favorite resturaunt: ")
    favorite_restaurant["favorite_dish"] = input("Enter your favorite dish at the resturaunt: ")
